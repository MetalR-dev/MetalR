...
export default function PhotovoltaiquePage() {
  ...
  return (
    <>
      ...
      <section ref={ref} className="relative mb-20 bg-[#F7F7F7]">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <motion.div
            ...
            className="pv-split-panel grid grid-cols-1 lg:grid-cols-5 rounded-2xl overflow-hidden border border-[#E0E0E0] shadow-sm bg-white"
            style={{ height: "560px" }}
          >
      ...
      <section className="pv-certs-section" style={{ backgroundColor: "#1A1A1A", borderRadius: 24, maxWidth: 1280, margin: "0 auto 80px", padding: "56px 48px" }}>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
